 ...
 * @return `VkFormat` the corresponding format
 */
inline static VkFormat __toVkFormat(GLGE::Graphic::VertexLayout::Type t) {
    switch (t) {
        case GLGE::Graphic::VertexLayout::Type::Float:  return VK_FORMAT_R32_SFLOAT;
        case GLGE::Graphic::VertexLayout::Type::vec2:   return VK_FORMAT_R32G32_SFLOAT;
        case GLGE::Graphic::VertexLayout::Type::vec3:   return VK_FORMAT_R32G32B32_SFLOAT;
        case GLGE::Graphic::VertexLayout::Type::vec4:   return VK_FORMAT_R32G32B32A32_SFLOAT;

        case GLGE::Graphic::VertexLayout::Type::Int:    return VK_FORMAT_R32_SINT;
        case GLGE::Graphic::VertexLayout::Type::ivec2:  return VK_FORMAT_R32G32_SINT;
        case GLGE::Graphic::VertexLayout::Type::ivec3:  return VK_FORMAT_R32G32B32_SINT;
        case GLGE::Graphic::VertexLayout::Type::ivec4:  return VK_FORMAT_R32G32B32A32_SINT;

        case GLGE::Graphic::VertexLayout::Type::UInt:   return VK_FORMAT_R32_UINT;

        case GLGE::Graphic::VertexLayout::Type::unorm_u8x1: return VK_FORMAT_R8_UNORM;
        case GLGE::Graphic::VertexLayout::Type::unorm_u8x2: return VK_FORMAT_R8G8_UNORM;
        case GLGE::Graphic::VertexLayout::Type::unorm_u8x4: return VK_FORMAT_R8G8B8A8_UNORM;

        case GLGE::Graphic::VertexLayout::Type::snorm_u8x1: return VK_FORMAT_R8_SNORM;
        case GLGE::Graphic::VertexLayout::Type::snorm_u8x2: return VK_FORMAT_R8G8_SNORM;
        case GLGE::Graphic::VertexLayout::Type::snorm_u8x4: return VK_FORMAT_R8G8B8A8_SNORM;
 ...
 : GLGE::Graphic::Backend::Graphic::Material(shader, layout, fbuff, cullMode, depthMode, depthWrite)
{
    ...
    std::vector<VkVertexInputBindingDescription> streams;
    streams.reserve(m_layout->getStreamCount());
    for (size_t i = 0; i < m_layout->getStreamCount(); ++i) {
        //create the stream
        VkVertexInputBindingDescription descr {};
        descr.binding = i;
        descr.inputRate = VK_VERTEX_INPUT_RATE_VERTEX;
        descr.stride = m_layout->getStreamStride(i);
        streams.push_back(descr);
    }
    for (size_t i = 0; i < m_layout->getAttributeCount(); ++i) {
        ...
        attrDesc.binding = attr.streamId;
        attrDesc.format = __toVkFormat(attr.type);
        attrDesc.location = i;
        attrDesc.offset = attr.streamOffset;
    ...
    vertInputCreate.vertexBindingDescriptionCount = streams.size();
    vertInputCreate.pVertexBindingDescriptions = streams.data();
