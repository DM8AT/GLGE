...
namespace GLGE::Graphic::Backend::Graphic {
    ...
    public:
         ...
         */
        virtual Reference<GLGE::Graphic::Backend::Graphic::Texture> createTexture([[maybe_unused]] const uvec2& size, [[maybe_unused]] u16 mipCount, [[maybe_unused]] PixelFormat format) = 0;
         ...
         */
        virtual Reference<GLGE::Graphic::Backend::Graphic::Image> createImage([[maybe_unused]] const uvec2& size, [[maybe_unused]] PixelFormat format, [[maybe_unused]] u8 samples) = 0;
