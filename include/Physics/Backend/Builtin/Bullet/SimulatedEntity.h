 ...
 * @author DM8AT
 * @brief define the simulated entity backend override for bullet
 * @version 0.1
 * @date 2026-06-04
 * 
 ...
 */
//header guard
#ifndef _GLGE_PHYSICS_BACKEND_BULLET_SIMULATED_ENTITY_
#define _GLGE_PHYSICS_BACKEND_BULLET_SIMULATED_ENTITY_

//add the simulated entity glue layer
...
namespace GLGE::Physic::Backend::Bullet {
    ...
    public:
         ...
         */
        SimulatedEntity(Backend::World* world, const Reference<Backend::Collider>& collider, BodyType type, float mass, float friction, float restitution, bool highQualityCollision);
         ...
         * @brief Get the Body
         * 
         * @return `btRigidBody*` a pointer to the rigid body
         */
        inline btRigidBody* getBody() const noexcept
        {return m_body.get();}
         ...
         */
        inline void setBody(std::unique_ptr<btRigidBody>& body) noexcept
    ...
    protected:
        ...
        /**
         * @brief store the rigid body
         */
        std::unique_ptr<btRigidBody> m_body;
        /**
         * @brief store the state
         */
