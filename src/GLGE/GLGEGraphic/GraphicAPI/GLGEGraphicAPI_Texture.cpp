...
void GraphicTexture::create(void* data, bool isHDR, const uvec2& size, GraphicInstance* instance)
{
    ...
    uint64_t datSize = ((m_isHDR) ? sizeof(float) : sizeof(uint8_t)) * 4 * m_size.x * m_size.y;
    //create the data
