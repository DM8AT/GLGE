...
typedef struct GLGE_VEC_STRUCT_NAME {
     ...
     */
    inline GLGE_VEC_STRUCT_NAME() noexcept : x(0), y(0), z(0), w(0) {}

    /**
     * @brief Construct a new three dimensional vector
     * 
     * @param _xyzw the value for the x, y, z and w axis
     */
    inline GLGE_VEC_STRUCT_NAME(const GLGE_VEC_TYPE& _xyzw) noexcept : x(_xyzw), y(_xyzw), z(_xyzw), w(_xyzw) {}
     ...
     * @param _w the new value for the w axis
     */
    inline GLGE_VEC_STRUCT_NAME(const GLGE_VEC_TYPE& _x, const GLGE_VEC_TYPE& _y, const GLGE_VEC_TYPE& _z, const GLGE_VEC_TYPE& _w) noexcept : x(_x), y(_y), z(_z), w(_w) {}
     ...
     */
    inline GLGE_VEC_STRUCT_NAME operator-() const noexcept {return GLGE_VEC_STRUCT_NAME(-x, -y, -z, -w);}
     ...
     */
    inline GLGE_VEC_STRUCT_NAME operator+(const GLGE_VEC_STRUCT_NAME& ot) const noexcept {return GLGE_VEC_STRUCT_NAME(ot.x + x, ot.y + y, ot.z + z, ot.w + w);}
     ...
     */
    inline GLGE_VEC_STRUCT_NAME operator-(const GLGE_VEC_STRUCT_NAME& ot) const noexcept {return GLGE_VEC_STRUCT_NAME(x - ot.x, y - ot.y, z - ot.z, w - ot.w);}
     ...
     */
    inline std::string asString() const noexcept {return std::string(GLGE_STRINGIFY_DEFINE(GLGE_VEC_NAME))+ "{" + std::to_string(x) + ", " + std::to_string(y) + ", " + std::to_string(z) + ", " + std::to_string(w) + "}";}
    ...
    GLGE_VEC_TYPE z;
    /**
     * @brief store the value for the w axis
     */
    GLGE_VEC_TYPE w;
} GLGE_VEC_NAME;

/**
 * @brief create a new 4D vector
 * 
 ...
 */
GLGE_FUNCTION_INLINE GLGE_VEC_NAME GLGE_C_FUNC(GLGE_DEFINE_CONCATINATE(GLGE_VEC_NAME, _create))(GLGE_CONST_REF(GLGE_VEC_TYPE) x, GLGE_CONST_REF(GLGE_VEC_TYPE) y, GLGE_CONST_REF(GLGE_VEC_TYPE) z, GLGE_CONST_REF(GLGE_VEC_TYPE) w) GLGE_FUNC_NOEXCEPT
{
    //check if this is C++
    #if GLGE_CPP
    //use the C++ constructor 
    return GLGE_VEC_NAME(x, y, z, w);
    //else, this is C
    #else
 ...
 * @brief create a new 4D vector
 * 
 * @param xyzw the value for the x, y, z and w axis
 */
GLGE_FUNCTION_INLINE GLGE_VEC_NAME GLGE_C_FUNC(GLGE_DEFINE_CONCATINATE(GLGE_VEC_NAME, _createSingle))(GLGE_CONST_REF(GLGE_VEC_TYPE) xyzw) GLGE_FUNC_NOEXCEPT
{
    //check if this is C++
    #if GLGE_CPP
    //use the C++ constructor 
    return GLGE_VEC_NAME(xyzw);
    //else, this is C
    #else
    //use the C compound structure
    return (GLGE_VEC_NAME){xyzw, xyzw, xyzw, xyzw};
    #endif
}
...
GLGE_FUNCTION_INLINE GLGE_VEC_NAME GLGE_C_FUNC(GLGE_DEFINE_CONCATINATE(GLGE_VEC_NAME, _add))(GLGE_CONST_REF(GLGE_VEC_NAME) a, GLGE_CONST_REF(GLGE_VEC_NAME) b) GLGE_FUNC_NOEXCEPT
{
    ...
    return (GLGE_VEC_NAME){a.x+b.x, a.y+b.y, a.z+b.z, a.w+b.w};
    #endif
}
...
GLGE_FUNCTION_INLINE GLGE_VEC_NAME GLGE_C_FUNC(GLGE_DEFINE_CONCATINATE(GLGE_VEC_NAME, _negate))(GLGE_CONST_REF(GLGE_VEC_NAME) vec) GLGE_FUNC_NOEXCEPT
{
    ...
    return (GLGE_VEC_NAME){-vec.x, -vec.y, -vec.z, -vec.w};
    #endif
}
