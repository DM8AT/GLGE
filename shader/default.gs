...
*/
layout (packed, binding = 2) readonly buffer glge_Materials
{
    /**
...
*/
layout (packed, binding = 3) readonly buffer glge_Vertices
{
    /**
 ...
 */
layout (packed, binding = 4) readonly buffer glge_Indices
{
    /**
